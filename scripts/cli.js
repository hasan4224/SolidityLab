...
const contractABI = require("../artifacts/contracts/Soliditylab.sol/Soliditylab.json").abi;

program
    .name("soliditylab-cli")
    .description("CLI tool for Soliditylab smart contract")
    .version("1.0.0");
