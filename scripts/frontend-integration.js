 ...
 * This file demonstrates how to integrate Soliditylab with a web frontend
 */

// For React/Vue/Angular applications
export class SoliditylabClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new SoliditylabClient(provider, contractAddress);
